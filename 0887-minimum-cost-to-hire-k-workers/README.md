<h2><a href="https://leetcode.com/problems/minimum-cost-to-hire-k-workers/?envType=problem-list-v2&envId=heap-priority-queue">887. Minimum Cost to Hire K Workers</a></h2><h3>Hard</h3><hr><p>There are <code>n</code> workers. You are given two integer arrays <code>quality</code> and <code>wage</code> where <code>quality[i]</code> is the quality of the <code>i<sup>th</sup></code> worker and <code>wage[i]</code> is the minimum wage expectation for the <code>i<sup>th</sup></code> worker.</p>
